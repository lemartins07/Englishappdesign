...
export function LandingHeader({ onLogin, onGetStarted, theme, onToggleTheme }: LandingHeaderProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['hero', 'como-funciona', 'metodo', 'demo', 'depoimentos', 'beneficios', 'faq'];
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button 
              variant="ghost" 
              onClick={onLogin}
              className={isScrolled ? '' : 'text-neutral-700 dark:text-neutral-200 hover:text-neutral-900 dark:hover:text-white'}
            >
              Entrar
            </Button>
