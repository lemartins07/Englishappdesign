...
const testimonials = [
  {
    ...
    avatar: 'M',
    quote: 'Passei na minha entrevista para uma vaga remota em Londres depois de 3 semanas usando o app.',
    rating: 5
  },
  {
    name: 'Carlos R.',
    ...
    avatar: 'C',
    quote: 'O Teacher AI me ajudou a praticar respostas técnicas em inglês. Método realmente eficaz!',
    rating: 5
  },
  {
    name: 'Beatriz L.',
...
const benefits = [
  ...
  { icon: Target, title: 'Conteúdo adaptado à sua área', description: 'Frontend, Backend, Data, DevOps' },
  ...
  { icon: MessageCircle, title: 'Simulador de entrevistas', description: 'Pratique cenários reais' }
];
...
const faqs = [
  {
    ...
    answer: 'O teste de nivelamento e a primeira semana são gratuitos. Você pode experimentar todas as funcionalidades sem compromisso.'
  },
  {
    question: 'Preciso falar inglês avançado para começar?',
    answer: 'Não! A IA adapta tudo ao seu nível atual. Desde iniciantes até avançados podem se beneficiar do método APA.'
  },
  {
  ...
  },
  {
    ...
    answer: 'É com o Teacher AI, treinado com base em professores certificados e feedback real de alunos. Ele está disponível 24/7!'
  },
  {
    question: 'Quanto tempo leva para ver resultados?',
    answer: 'A maioria dos alunos relata maior confiança já na primeira semana. Resultados significativos aparecem após 3-4 semanas de prática consistente.'
  }
];

export function LandingPage({ onGetStarted, onUpdateProfile, theme, onToggleTheme }: LandingPageProps) {
  const [email, setEmail] = useState('');

  const handleGetStarted = () => {
    if (email) {
      onUpdateProfile({ name: email.split('@')[0] });
    }
    onGetStarted();
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 dark:from-neutral-950 dark:via-purple-950/20 dark:to-neutral-950">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center max-w-4xl mx-auto space-y-8">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-neutral-900 dark:text-white leading-tight">
            ...
            >
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Preparado para:</span>
              {['React', 'Node.js', 'Python', 'AWS', 'Docker'].map((tech) => (
                <Badge key={tech} variant="outline" className="text-neutral-600 dark:text-neutral-400">
                  {tech}
                </Badge>
              ))}
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Gerado por IA conforme seu nível e objetivo (entrevista, fluência, viagem).'
              },
              {
                icon: MessageCircle,
                step: '3',
      ...
      {/* APA Method */}
      <section id="metodo" className="py-16 sm:py-24 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-neutral-950 dark:to-purple-950/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <Badge variant="outline" className="mb-4">Metodologia Exclusiva</Badge>
            <h2 className="text-3xl sm:text-4xl mb-4 dark:text-white">
              Método APA — Automatic Presentation & Assimilation™
            </h2>
            <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto">
              Cada lição é projetada para <strong>apresentar, assimilar e ativar</strong> o conteúdo de forma natural.
              <br />Sem traduções. Sem decoreba. Apenas prática real.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-neutral-600 dark:text-neutral-300 mb-6">
                Você vai se surpreender com o quanto entende em minutos.
                Veja como funciona o Teacher AI e o feedback instantâneo.
              </p>
      ...
      {/* Social Proof */}
      <section id="depoimentos" className="py-16 sm:py-24 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/10 dark:to-neutral-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-8">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-8">
              Comece hoje mesmo seu plano gratuito de 7 dias e descubra seu verdadeiro nível de inglês.
            </p>
          </motion.div>
          ...
          <p className="text-sm text-white/80">
            Sem cartão • Cancelamento automático após o teste
          </p>
        </div>
      </section>
      ...
      <section id="faq" className="py-16 sm:py-24 bg-white dark:bg-neutral-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, idx) => (
              <AccordionItem key={idx} value={`item-${idx}`} className="border rounded-lg px-6 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Método APA</a></li>
